# Daily Macro Evidence Report (2026-08-22)
...
- **Input ages:** dff `0` days, core_pce `0` days, rstar `0` days, fed_assets `3` days, tga `3` days, rrp `3` days, nominal_gdp `143` days, effr `0` days, iorb `0` days, sofr `0` days.
...
| `AXP` | Capital Markets | Fair vs Historical Cohort Relationship | `NEUTRAL` | Current FPE cohort-relative ratio (1.06x) is 17.9% below its historical median (1.30x) across 60+ observations.<br>The 17.9% relative discount does not meet the 20.0% WATCH threshold; posture remains NEUTRAL. | No valid current EVE multiple is available. |
...
| `CEG` | Downstream Power & Grid | Discounted vs Historical Cohort Relationship | `WATCH` | Current FPE cohort-relative ratio (0.79x) is 22.8% below its historical median (1.02x) across 60+ observations.<br>The 22.8% relative discount meets the 20.0% WATCH threshold.<br>Current EVE cohort-relative ratio (0.55x) is 22.8% below its historical median (0.71x) across 60+ observations. | — |
| `ETN` | Downstream Power & Grid | Fair vs Historical Cohort Relationship | `NEUTRAL` | Current FPE cohort-relative ratio (1.27x) is 23.7% above its historical median (1.03x) across 60+ observations.<br>The 23.7% relative discount does not meet the 20.0% WATCH threshold; posture remains NEUTRAL.<br>Current EVE cohort-relative ratio (1.82x) is 29.6% above its historical median (1.40x) across 60+ observations.<br>The 29.6% relative discount does not meet the 20.0% WATCH threshold; posture remains NEUTRAL. | — |
| `GEV` | Downstream Power & Grid | Fair vs Historical Cohort Relationship | `NEUTRAL` | Current FPE cohort-relative ratio (1.85x) is 23.9% above its historical median (1.50x) across 60+ observations.<br>The 23.9% relative discount does not meet the 20.0% WATCH threshold; posture remains NEUTRAL.<br>Current EVE cohort-relative ratio (4.13x) is 29.7% above its historical median (3.19x) across 60+ observations.<br>The 29.7% relative discount does not meet the 20.0% WATCH threshold; posture remains NEUTRAL. | — |
...
| `AMD` | Fabless Accelerators | Fair vs Historical Cohort Relationship | `NEUTRAL` | Current FPE cohort-relative ratio (1.85x) is 93.9% above its historical median (0.96x) across 60+ observations.<br>The 93.9% relative discount does not meet the 20.0% WATCH threshold; posture remains NEUTRAL.<br>Current EVE cohort-relative ratio (2.56x) is 75.1% above its historical median (1.46x) across 60+ observations.<br>The 75.1% relative discount does not meet the 20.0% WATCH threshold; posture remains NEUTRAL. | — |
...
| `QCOM` | Fabless Accelerators | Fair vs Historical Cohort Relationship | `NEUTRAL` | Current FPE cohort-relative ratio (0.83x) is 16.4% below its historical median (1.00x) across 60+ observations.<br>The 16.4% relative discount does not meet the 20.0% WATCH threshold; posture remains NEUTRAL.<br>Current EVE cohort-relative ratio (0.34x) is 11.1% below its historical median (0.39x) across 60+ observations.<br>The 11.1% relative discount does not meet the 20.0% WATCH threshold; posture remains NEUTRAL. | — |
...
| `MRK` | Pharmaceuticals | Fair vs Historical Cohort Relationship | `NEUTRAL` | Current FPE cohort-relative ratio (0.84x) is 13.8% above its historical median (0.73x) across 60+ observations.<br>The 13.8% relative discount does not meet the 20.0% WATCH threshold; posture remains NEUTRAL.<br>Current EVE cohort-relative ratio (0.80x) is 13.9% above its historical median (0.70x) across 60+ observations.<br>The 13.9% relative discount does not meet the 20.0% WATCH threshold; posture remains NEUTRAL. | — |
...
| `ADBE` | Software & Cloud | Fair vs Historical Cohort Relationship | `NEUTRAL` | Current FPE cohort-relative ratio (0.74x) is 20.0% above its historical median (0.62x) across 60+ observations.<br>The 20.0% relative discount does not meet the 20.0% WATCH threshold; posture remains NEUTRAL.<br>Current EVE cohort-relative ratio (0.62x) is 11.1% below its historical median (0.69x) across 60+ observations.<br>The 11.1% relative discount does not meet the 20.0% WATCH threshold; posture remains NEUTRAL. | — |
| `CRM` | Software & Cloud | Fair vs Historical Cohort Relationship | `NEUTRAL` | Current FPE cohort-relative ratio (1.00x) is 23.9% above its historical median (0.81x) across 60+ observations.<br>The 23.9% relative discount does not meet the 20.0% WATCH threshold; posture remains NEUTRAL.<br>Current EVE cohort-relative ratio (0.85x) is 7.1% below its historical median (0.91x) across 60+ observations.<br>The 7.1% relative discount does not meet the 20.0% WATCH threshold; posture remains NEUTRAL. | — |
...
| `ORCL` | Software & Cloud | Fair vs Historical Cohort Relationship | `NEUTRAL` | Current FPE cohort-relative ratio (1.00x) is 19.3% below its historical median (1.23x) across 60+ observations.<br>The 19.3% relative discount does not meet the 20.0% WATCH threshold; posture remains NEUTRAL.<br>Current EVE cohort-relative ratio (1.18x) is 19.5% below its historical median (1.46x) across 60+ observations.<br>The 19.5% relative discount does not meet the 20.0% WATCH threshold; posture remains NEUTRAL. | — |
...
| :--- | :--- | :--- |
| **CBOE Volatility (VIX)** | `15.13` | `Low Volatility (Complacency)` |
| **US Dollar Index (DXY)** | `98.80` | Global Currency Tightness |
...
| **WTI Crude Oil** | `$87.06` | Energy Cost Drivers |
| **Gold** | `$4,624.10` | Monetary Protection / Safe Haven |
