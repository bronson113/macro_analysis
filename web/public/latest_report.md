...
| :--- | :--- | :--- |
| **Reserve Liquidity Proxy** | **$5,911.29 B** | **30-Day Change: +135.29 B** |
...
| **5. Downstream Datacenter Cooling** | `VRT`, `MOD`, `SMCI` | `21.11x` | `31.06x` | `25.0x` | `Fairly Valued` |
| **6. Semiconductor EUV Equipment** | `ASML`, `AMAT`, `LRCX`, `KLAC` | `35.10x` | `47.17x` | `26.0x` | `Rich Multiple / Growth Premium` |
| **7. Critical Materials & Magnets** | `FCX`, `MP` | `29.16x` | `11.10x` | `18.0x` | `Rich Multiple / Growth Premium` |
...
| **US Dollar Index (DXY)** | `101.13` | Global Currency Tightness |
...
| **WTI Crude Oil** | `$83.94` | Energy Cost Drivers |
| **Gold** | `$4,099.10` | Monetary Protection / Safe Haven |
